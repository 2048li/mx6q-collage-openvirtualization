...
#ifdef TOUCH_SUPPORT
/**
* @brief On touch of pay button, keyon_pay bitmap is loaded  
*/
...
/**
* @brief On release event of pay button  
*/
...
/**
* @brief Initialize window Set orientation and draw the bitmap of other fields 
*		such as creditcard amount passcode logo textfield pay button 
* @return 
*/
s32int vk_app(void)
{
	...
	sw_strcpy((char *)text1, "Enter Text...\0");
	sw_strcpy((char *)text2, "Enter Passcode...\0");

	textfield_on_given_coord(200, 340, text1, (u8*)"TextField\0", 205, 
			45, 0xffffffff, NO_PASSWORD);

	active_tf = obj_val.obj_count;
	textfield_on_given_coord(200, 430, text2, (u8*)"Password\0", 205,

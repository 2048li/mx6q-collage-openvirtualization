		...
		u32 color)
{
	...
	sw_strcpy((char*)obj_val.obj_id[obj_val.obj_count], (char*)id);
	...
	if((sw_strcmp((char*)type, "textfield\0") == 0) || (sw_strcmp((char*)type, "password\0")
				== 0))

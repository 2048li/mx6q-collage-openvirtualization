...
extern char clicked_text[500][200];
...
extern struct gui_info gui_info;
...
extern struct obj_values obj_val;
...
* @param active_tf
*/
extern void set_active_textbox_layout(s32int active_tf);
...
* @param active_tf
*/
extern void set_inactive_textbox_layout(s32int active_tf);
...
extern void bitmap_on_given_coord(s32int x, s32int y, s32int width, 
		s32int height, u32 *bmp_array, char* id);
...
* @param id
*/
extern void bitmap(s32int width, s32int height, u32* bmp_array, char* id);
...
/**
* @brief Function to draw button given x and y coordinates
*
* @param x
* @param y
* @param str
...
extern void label_on_given_coord(s32int x, s32int y, u8* str, u8* id, 
		s32int width, s32int height, u32 col);
...
extern void textfield_on_given_coord(s32int x, s32int y, u8* str, u8* id, 
		s32int width, s32int height, u32 col, u32 password);
...
* @param id[]
*/
extern void set_text(char* str, u8 id[]);

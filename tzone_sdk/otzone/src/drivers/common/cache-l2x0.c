...
/**
* @brief write value val to l2cache at offset away from base address 
*
* @param val
* @param offset
*/
...
/**
* @brief Reads the value at offset address of l2 cache memory 
*
* @param offset
*
* @return 
...
/**
* @brief To check whether the revision is PL310
*
* @param rev
*
* @return 
...
/**
* @brief waits for the cache operation by line or way to complete 
*
* @param reg
* @param mask
*/
...
/**
* @brief cache wait operation pertaining to PL310 revision
*
* @param reg
* @param mask
*/
...
/**
* @brief Waits till other operations such as flush or clean 
*			or invalidate is completed 
*/
...
/**
* @brief cleans a particular line of the l2cache pointed by addr 
*
* @param addr
*/
...
/**
* @brief Invalidate a particular line of l2cache pointed by addr
*
* @param addr
*/
...
/**
* @brief Sets the cache debug control register
*
* @param val
*/
...
/**
* @brief Writes value to the debug control register 
*
* @param val
*/
...
/**
* @brief cleans and invalidates a particular line of l2cache
*
* @param addr
*/
...
/**
* @brief cleans and invalidates a particular line of l2cache by passing the address 
*
* @param addr
*/
static inline void l2x0_flush_line(u32 addr)
...
/**
* @brief waits till other cache maintenance operations 
*				are completed  
*/
...
/**
* @brief flushes all lines of l2cache memory  
*/
...
/**
* @brief cleans all lines of l2cache memory 
*/
...
/**
* @brief Invalidate all lines of l2cache memory
*/
...
/**
* @brief Invalidate a range of lines in l2cache memory
*		by passing the start and end address
* @param start
* @param end
*/
...
/**
* @brief cleans a range of lines in l2cache memory 
*		passing the start and end address
* @param start
* @param end
*/
...
/**
* @brief Flushes a range of lines of l2cache memory 
*		passing the start and end addresses
* @param start
* @param end
*/
...
//	spin_unlock_irqrestore(&l2x0_lock, flags);
 ...
 /**
* @brief enables l2x0 after l2x0_disable, does not invalidate
*/
...
/**
* @brief invalidates and disables the l2cache memory
*/
...
/**
* @brief flushes l2cache memory and disables it 
*
* @param flush
*/
...
/**
* @brief unlocks a particular l2cache memory associated with cache_id  
*
* @param cache_id
*/
...
/**
* @brief initialize variables in cache memory 
*		base and lock variables
* @param base
*/
...
/**
* @brief Sets the prefetch control register
*
* @param prefetch
*/

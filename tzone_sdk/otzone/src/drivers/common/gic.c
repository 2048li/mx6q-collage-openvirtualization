...
/**
* @brief Checks whether the guest interrupt request is active or not 
*
* @param guest
*
* @return 
...
/**
 * @brief reads the generic interrupt control register  
 *		
 * @param gic_nr
 *
 * @return 
...
/**
 * @brief Acknowledges the interrupt request of Generic interrupt controller
 *
 * @param gic_nr
 * @param irq
 *
...
/**
 * @brief Masks a particular interrupt request of the generic interrupt controller 
 *
 * @param gic_nr
 * @param irq
 *
...
/**
 * @brief Unmask a particular interrupt request of the Generic interrupt controller
 *
 * @param gic_nr
 * @param irq
 *
...
/**
 * @brief This function is to initialize distributor block of  
...
/**
 * @brief This function is used to initialize CPU interfaces of 
 *			Generic interrupt controller
 * @return 
 */
...
/**
 * @brief This function is used to generate software interrupt 
 *
 * @param int_id
 */
...
/**
* @brief Generate software interrupt specific to core0 
*
* @param int_id
*/

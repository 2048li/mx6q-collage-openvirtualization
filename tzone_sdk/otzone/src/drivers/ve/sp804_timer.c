...
/**
 * @brief Reads the free running counter value of the timer 
 *
 * @return 
 */
...
/**
 * @brief This function is called to retrieve the timer period 
 *
 * @return 
 */
...
/**
* @brief This function is called to retrieve the clock period
*
* @return 
*/

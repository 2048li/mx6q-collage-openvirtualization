...
{ 
	...
	psa_config->entry_point = (u32)&virtual_keyboard_task;
	psa_config->process = (int(*)(u32 ,void*, u32,void*,u32, struct otzc_encode_meta *, u32*))&process_otz_virtual_keyboard_svc;
#endif
...
#endif
#ifndef CONFIG_SW_ELF_LOADER_SUPPORT
	psa_config->entry_point = (u32)&mutex_test_task;
	psa_config->process =  (int(*)(u32 ,void*, u32,void*,u32, struct otzc_encode_meta *, u32*))&process_otz_mutex_test_svc;
#endif

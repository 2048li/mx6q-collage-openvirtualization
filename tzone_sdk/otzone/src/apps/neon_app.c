/*
 * @brief Neon context switching test application
 *
 * This test application to validate the VFP context switching
 */

#include <neon_app.h>
 
/**
* @brief Adds 3 to the value passed in the argument 
*
* @param data
*/
...
/**
* @brief Prints the data passed in the argument
*
* @param data
* @param name
*/
...
/**
* @brief Main function of the neon app
*
* @return 
*/
int test_neon_app() {

 ...
 * SHA, HMAC and Cipher Algorithm Tests
 */
...
/**
* @brief Digest algorithm tests 
*
* @param input_buf virtual address of input buffer
* @param input_len input buffer length
* @param output_buf virtual address of output buffer 
* @param output_len output buffer length
* @param svc_cmd_id command identifier
*
* @return 
*/
...
/**
* @brief API for HMAC algorithm tests
*
* @param input_buf
* @param input_len
* @param key_buf
...
* @param input_buf virtual address of input buffer
* @param input_len input buffer length
* @param key_buf virtual address of key buffer
...
/**
* @brief API for cipher algorithm tests 
*
* @param input_buf virtual address of input buffer
* @param input_len input buffer length
* @param init_vector virtual address of init vector
* @param init_vector_len init vector length 
* @param key_buf virtual address of key buffer
* @param key_len key buffer length
* @param output_buf virtual address of output buffer
* @param output_len output buffer length
* @param svc_cmd_id command identifier 
* @param cipher_choice encryption/decryption choice
*
* @return 
*/

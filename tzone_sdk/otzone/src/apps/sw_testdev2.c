...
{
    sw_printf("SW:  Test device -2  open call\n");
    return;
}
...
{
    sw_printf("SW: Test device -2 close call\n");
    return;
}

/**
 * @brief File operations structure of the device
 */
...
/**
 * @brief registers the file operations structure of the device 
 *
 * @return 
 */
...
/**
 * @brief unregisters the file operations structure of the device
 */

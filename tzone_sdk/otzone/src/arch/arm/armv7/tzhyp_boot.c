...
/**
* @brief Load all the guests onto the memory
*/
static void tzhyp_load_guests(void)
{
	int guest;
...
/**
* @brief Initialize the register context for all the guests
*/
static void tzhyp_guest_context_init(void)
{
	int guest, core;
...
/**
* @brief Hypervisor boot event handler  
*
* @param x timer event structure
*/
...
/**
* @brief  Hypervisor boot ack event
*/

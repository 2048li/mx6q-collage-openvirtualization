...
/**
* @brief convert the endianess of the given value 
*
* @param value
*
* @return 
...
/**
* @brief reads the parameters of the image addr and stored in the 
*		passed image_header structure
* @param image_addr
* @param image_header
*/
...
/**
* @brief Initializes and sets up the start tag structure
*
* @param params
*
* @return 
...
/**
* @brief sets up the command line tag structure
*
* @param params
* @param commandline
*
...
struct tag * setup_commandline_tag (struct tag *params, char *commandline)
{
	...
	params->hdr.size =
		(sizeof (struct tag_header) + sw_strlen (p) + 1 + 4) >> 2;

	sw_strcpy (params->u.cmdline.cmdline, p);
...
/**
* @brief sets up the structure members of params structure with initrd values 
*
* @param params
* @param initrd_start
* @param initrd_end
...
/**
* @brief sets up the param structure with end tag parameters
*
* @param params
*
* @return 
...
/**
* @brief sets up the param structure with memory tag parameters 
*
* @param nr_dram_banks
* @param dram_start

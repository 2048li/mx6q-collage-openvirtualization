...
/**
* @brief Device open system call
*/
void __sw_open();

/**
* @brief Device close system call
*/
void __sw_close();

/**
* @brief Device read system call 
*/
void __sw_read(void);


/**
* @brief Device write system call 
*/
void __sw_write();

/**
* @brief Device ioctl system call
*/
...
/**
* @brief initialize liquid crystal display
*
* @param width
* @param height
*

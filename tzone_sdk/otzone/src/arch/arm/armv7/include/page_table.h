...
/*!Priv no access, usr no access */
  PRIV_NO_USR_NO = __extension__ 0b000,   
/*!Priv read/write, usr no access */
  PRIV_RW_USR_NO = __extension__ 0b001,   
/*!Priv read/write, usr read only */
  PRIV_RW_USR_RO = __extension__ 0b010,   
/*!Priv read/write, usr read/write */
  PRIV_RW_USR_RW = __extension__ 0b011,   
/*!Reserved */
  AP_RESERVED = __extension__ 0b100,
/*!Priv read only, usr no access */
  PRIV_RO_USR_NO= __extension__ 0b101,    
/*!Deprecated */
  DEPRECATED=__extension__ 0b110,         
/*!Priv read only, usr read only */
  PRIV_RO_USR_RO= __extension__ 0b111,    
};
...
/**
* @brief Map a range of secure memory
*
* This function assumes that the start address and size are section aligned.
*
* @param va : virtual address

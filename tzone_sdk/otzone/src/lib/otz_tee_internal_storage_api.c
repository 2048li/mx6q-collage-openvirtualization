...
/**
 * @brief Returns the characteristics of an object 
 *
 * @param object
 * @param objectInfo
 */
...
/**
* @brief Restricts the object usage flag of an object handled
*
* @param object
* @param objectUsage
*/
...
*		attribute identified by the attributeID
* @param object
* @param attributeID
* @param buffer
* @param size
...
/**
* @brief Extracts one value attribute from an object
*		attribute identified by the attributeID
* @param object
* @param attributeID
* @param a
...
/**
* @brief Allocates an uninitialized transient object 
*
* @param objectType
* @param maxObjectSize
* @param object
...
/**
* @brief deallocates a transient object previously allocated with
...
/**
* @brief Function populates an uninitialized object container with object
	...
	uint32_t attrCount)
{
	...
	object.Attribute=(TEE_Attribute*)TEE_Malloc(attrCount* sizeof(TEE_Attribute),0);
...
/**
* @brief Helper function that can be used to populate a single attribute
*		with reference to a buffer
* @param attr
* @param attributeID
* @param buffer
* @param length
...
/**
* @brief Helper function that can be used to populate a single attribute
*		with reference to integer value
* @param attr
* @param attributeID
* @param a
* @param b
...
/**
* @brief function populates an uninitialized object handle destObject 
*	with the attributes of another object handle srcObject
*
* @param destObject handle on uninitialized object handle 
* @param srcObject  handle on an initialized object
*/
...
/**
* @brief Creates a persistent object with initial attributes and an
* 	initial data stream content, 
...
/**
* @brief Marks an object for deletion and closes the object handle
*
* @param object
*/
...
/**
* @brief Changes the identifier of the object 
*
* @param object
* @param newObjectID
	...
	size_t newObjectIDLen)
{
	...
	if(ofp == NULL && (char*)File_name==NULL) {
...
/**
* @brief Allocates a handle on an object enumerator. 
*	Once an object enumerator handle has been allocated
*	it can be reused for multiple enumerations
*
...
{
	UNUSED(objectEnumerator);
	return TEE_SUCCESS;
}

/**
* @brief Deallocates all resources associated with an object enumerator handle. 
...
/**
* @brief Resets an object enumerator handle to its initial
...
/**
* @brief Starts the enumeration of all the persistent
* 		objects in a given Trusted Storage
*
* @param objectEnumerator
* @param storageID
*
...
/**
* @brief Gets the next object in an enumeration and returns
...
/**
* @brief Attempts to read size bytes from the data stream 
* associated with the object into the buffer
*
* @param object
* @param buffer
* @param size
...
/**
* @brief Writes size bytes from the buffer to the date stream  
*	associated with the open object handle
* @param object
* @param buffer
* @param size
*
	...
	size_t size )
{
	...
	if((int)wobj_value==-1 || errno==ENOSPC) {
...
/**
* @brief Changes the size of data stream
*
* @param object
* @param size
*
...
/**
* @brief Sets the data position indicator associated with the object handle  
*
* @param object
* @param offset
* @param whence
	...
	TEE_Whence whence )
{
	...
	if(sk_value==-1 || (u32)sk_value>TEE_DATA_MAX_POSITION) {

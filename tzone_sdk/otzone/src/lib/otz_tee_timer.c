...
/**
 * @brief This function is called to retrieve current system time 
 *
 * @param time
 */
...
/**
 * @brief Waits for specified number of milli seconds given in timeout
 *
 * @param timeout
 *
 * @return 
...
/**
 * @brief Sets the Persistent time of the current Trusted Apllication
 *
 * @param time
 *
 * @return 
...
/**
 * @brief Retrieves the persistent time of the Trusted Application
 *
 * @param time
 *
 * @return 
...
/**
 * @brief Retrieves the current REE system time
 *
 * @param time
 */

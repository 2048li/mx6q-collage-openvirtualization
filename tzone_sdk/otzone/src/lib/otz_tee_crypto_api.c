...
/**
* @brief Checks whether the algorithm is valid one or not  
*
* @param algorithm
*
* @return 
...
/**
* @brief Checks whether the mode passed in the parameter is valid or not 
*
* @param mode
*
* @return 
...
/**
* @brief Checks whether the algorithm and mode matches 
*
* @param mode
* @param algorithm
*
...
/**
* @brief MD5 and SHA algorithm allocations
*
...
/**
* @brief HMAC algorithm allocations
*
* @param localOperationHandle
*
* @return 
...
/**
* @brief Cipher algorithm allocations
*
* @param localOperationHandle
*
* @return 
...
/**
* @brief Clears the crypto_ctxt related to MD5 and SHA tests 
*
* @param operation
*/
...
/**
* @brief Clears the crypto_ctxt of HMAC algorithm tests
*
* @param operation
*/
...
/**
* @brief clears the crypto_ctxt related to cipher algorithm tests
*
* @param operation
*/
...
/**
* @brief Deallocates all resources associated with an operation handle.
* After this function is called, the operation handle is no longer valid
*
* @param operation
*/
...
/**
* @brief Returns information about operation handle 
*
* @param operation
* @param operationInfo
*/
...
/**
* @brief Resets the operation state before initialization
*		But after the key has been set 
* @param operation
*/
...
/**
* @brief Programs the key of an operation	
...
/**
* @brief copies an operation state from dstOperation to srcOperation 
*
* @param dstOperation
* @param srcOperation
*/
...
/**
* @brief This function is called to accumulate message data for hashing
*
* @param operation
* @param chunk
* @param chunkSize
...
/**
* @brief Finalizes the message digest operation and produces the message hash
*
* @param operation
* @param chunk
* @param chunkLen
...
/**
* @brief This function is used to start the symmetric cipher operation
*
* @param operation
* @param IV
* @param IVLen
...
/**
* @brief This function is used to encrypt or decrypt the input data
*
* @param operation
* @param srcData
* @param srcLen
...
/**
* @brief Finalizes the cipher operation, processing data that has not been
*	processed by previous calls to TEE_CipherUpdate 
*	as well as data supplied in srcData
*
* @param operation
* @param srcData
* @param srcLen
...
/**
* @brief Finalizes the MAC operation with a last chunk of message 
...
/**
* @brief Finalizes the MAC operation and compares the MAC 
*		with the buffer passed to the function
*
* @param operation
* @param message
* @param messageLen
...
/**
* @brief Feeds a new chunk of Additional Authentication Data (AAD)
*				to the AE operation
* @param operation
* @param AADdata
* @param AADdataLen
...
/**
* @brief Accumulates data for an Authentication Encryption Operation 
*
* @param operation
* @param srcData
* @param srcLen
...
/**
* @brief Processes data that has not been processed by previous calls to
* 	TEE_AEUpdate as well as data supplied in srcData
*
* @param operation
* @param srcData
* @param srcLen
...
/**
* @brief Encrypts a message with an asymmetric operation  
*
* @param operation
* @param params
* @param paramCount
...
/**
* @brief Decrypts a message with an assymetric operation
*
* @param operation
* @param params
* @param paramCount
...
/**
* @brief Signs a message digest signature with an asymmetric operation
*
* @param operation
* @param params
* @param paramCount
...
/**
* @brief  Verifies a message digest signature with an asymmetric operation
*
* @param operation
* @param params
* @param paramCount
...
/**
* @brief Can only be used with the algorithm TEE_ALG_DH_DERIVE_SHARED_SECRET
*
* @param operation
* @param params
* @param paramCount

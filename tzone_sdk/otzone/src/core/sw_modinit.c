...
void modules_init(void)
{
    ...
    init_start_addr = (u32)get_mod_init_start_addr();
    init_end_addr = (u32)get_mod_init_end_addr();
    for(init_fn_addr = (u32*)init_start_addr; init_fn_addr < (u32*)init_end_addr; init_fn_addr++){

 ...
 * Session, Context, and shared memory related operations
...
#endif
        strncpy_safe(temp_name, OTZ_CLIENT_FULL_PATH_DEV_NAME,sizeof(temp_name));
    }
    else {
        strncpy_safe(temp_name, name, sizeof(temp_name));
    }

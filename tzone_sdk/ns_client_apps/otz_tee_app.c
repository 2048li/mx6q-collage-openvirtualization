...
/* 
 * Global platform TEE client specification test application
 * to check zero copy testing,
...
/**
* @brief zero copy testing 
*	non-zero copy testing
...
int main(int argc, char* argv[])
{
    ...
    strncpy_safe(sharedMem1.buffer, 
        "test global platform client api: full memory reference  testing",sharedMem1.size);
    len = strlen(
...
*/
    ...
    strncpy_safe(sharedMem.buffer, 
        "test global platform client api: zero copy testing - inout", sharedMem.size);
    len = strlen(
...
*/
    ...
    strncpy_safe(testData, "test global platform client api: non-zero copy",sizeof(testData));
    ...
    strncpy_safe(testData, 
        "test global platform client api: testing temp memory reference",sizeof(testData));
    len = strlen(
